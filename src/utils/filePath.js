...
const SPONSOR_TIERS_FILE_PATH = `${STATIC_CONTENT_DIR_PATH}/sponsors-tiers.json`;
const SPONSOR_DATA_FILE_PATH = `${STATIC_CONTENT_DIR_PATH}/sponsors.json`;
...
exports.SPONSOR_TIERS_FILE_PATH = SPONSOR_TIERS_FILE_PATH;
exports.SPONSOR_DATA_FILE_PATH = SPONSOR_DATA_FILE_PATH;
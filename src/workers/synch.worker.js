...
const run = async ({
  ...
  if (localSummit === null) localSummit = JSON.parse(summit);

  if (localAllEvents === null) localAllEvents = JSON.parse(allEvents);

  if (localAllIDXEvents === null) localAllIDXEvents = JSON.parse(allIDXEvents);

  if (localAllSpeakers === null) localAllSpeakers = JSON.parse(allSpeakers);

  if (localAllIDXSpeakers === null) localAllIDXSpeakers = JSON.parse(allIDXSpeakers);
